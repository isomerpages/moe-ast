...
<input type="checkbox" id="accordion2">  
	...
	<table id="geography">
		<tbody><tr>
			...
			<td><img src="/images/geo3.png" style="width:80px;height:109px;margin-right:15px;" align="left"><strong>Ms Lum Kit Kuan Melanie</strong><br>Master Teacher / Geography<br><br><br>Email: <a href="mailto:Melanie_Lum@moe.gov.sg">Melanie_Lum@moe.gov.sg</a><br>Contact no.: 6664 1444</td>
	<td></td>
	</tr>
	</tbody></table>
	</div>
